...
@section('content')
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-responsive table-striped" class="display" id="tdservices">
                    <thead>
                    <tr>
                        <th>#</th>
                        ...
                        <tr class="">
                            ...
                            <td class="text-center">
                                ...
                                <div class="modal fade" id="modal{{ $service->id }}" tabindex="-1"
                                     aria-labelledby="deleteservice" aria-hidden="true" style="display: none;" role="dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('services.destroy', $service->id) }}" method="POST">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="deleteservice">Confimer la suppression</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    $service->label_service }}</span>. Cliquez sur "Confirmer" pour valider ou sur "Fermer" pour annuler... </p>
                                                    </p>
                                                </div>
